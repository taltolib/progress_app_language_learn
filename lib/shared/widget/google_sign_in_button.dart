...
/// Использует PushButton (такой же стиль как в LoginPage).
/// Логотип Google — загружается из интернета через Image.network.
class GoogleSignInButton extends StatelessWidget {
  /// Куда переходить после успешного входа. По умолчанию — '/home'.
